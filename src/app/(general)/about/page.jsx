...
const About = () => {
  ...
  const imgDevelopers = [
    { id: 1, img: "/assets/about/1737193816487.jpg" },
    { id: 2, img: "/assets/about/IMG_20251208_132531_500.jpg" },
    { id: 3, img: "/assets/about/1x1DSC01271.jpeg" },
    { id: 4, img: "/assets/about/2025 - 10_04PM 1.png" },
  ];
      ...
      <section className="flex flex-col md:flex-row items-center justify-center w-full px-6 md:px-16 py-10 gap-10">
        ...
        <div className="relative md:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-neut-700 mb-6 leading-relaxed">
            ...
            mengembangkan, dan memelihara website HUMIC sebagai sarana informasi
            dan publikasi riset.
          </p>
          ...
          <div className="grid grid-cols-2 gap-y-10 relative">
            ...
            <div className="flex flex-col gap-1 pr-6">
              ...
              <a
                href="https://www.linkedin.com/in/rayataufik"
            ...
            <div className="flex flex-col gap-1 pl-6">
              <h3 className="font-bold text-lg text-black">Akhtar M. Achsan</h3>
              <p className="text-neut-700 text-sm">Back End Developer</p>
              <a
                href="https://www.linkedin.com/in/akhtarmuhammadachsan"
                className="text-[#006DC0] text-sm flex items-center gap-1"
              >
                <FaLinkedin /> View on LinkedIn
              </a>
            ...
            <div className="flex flex-col gap-1 pr-6">
              <h3 className="font-bold text-lg text-black">Dinar M. Akbar</h3>
