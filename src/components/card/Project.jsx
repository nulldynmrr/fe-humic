...
export default function Project({ data = [], loading = false }) {
      ...
      {loading
        ...
        ? data.map((item, idx) => (
            ...
            >
              ...
              <div className="mt-4 flex flex-row items-start justify-between space-y-2">
                <div>
                  <div className="flex items-center text-gray-600 text-sm font-semibold">
                    <FaCalendarAlt className="mr-2 text-gray-500" />
                    {formatWaktu(item.created_at || item.date, "date") || "-"}
                  </div>
